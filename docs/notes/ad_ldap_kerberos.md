...
3) **Глобальный каталог** — перечень всех объектов AD и их свойств.
4) **Схема каталога** — набор определений всех типов объектов каталога и связанных с ними атрибутов.
...
![[Pasted image 20250220085146.png]]
